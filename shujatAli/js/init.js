...
// Update tilt options on hover
// jQuery('.tilt-effect').hover(
//     function() {
//         // Hover in - update tilt options for zoom-in
//         jQuery(this).tilt({
//             scale: 1.2, // Adjust the scale factor for zoom-in
//             speed: 800   // Adjust the speed for zoom-in
//         });
//     },
//     function() {
//         // Hover out - restore tilt options for zoom-out
//         jQuery(this).tilt({
//             scale: 1,    // Restore the default scale factor
//             speed: 500   // Restore the default speed
//         });
//     }
// );
jQuery('.tilteffect').on({
    mouseenter: function() {
        jQuery(this).animate({ 'zoom': 1.5 }, 500); // You can adjust the zoom level and duration
    },
    mouseleave: function() {
        jQuery(this).animate({ 'zoom': 1 }, 500); // Return to the original size
    }
});